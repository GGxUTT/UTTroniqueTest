...
#define MARGE 100 //Distance de sécurité % bord de table
#define SZX 3000 //Taille de la table
#define SZY 2000

#if 0 //950ms @216MHz STM32F7
#define NBX 19 //14   //Nombre de cases en X
#define NBY 12 //9	 //Nombre de cases en Y
...
static int SegIsInRect(const T_POINT *p1, const T_POINT *p2, const T_Rect *r)
   {
   float dxr, dyr;
   float a;
   int16_t dx, dy, x, y, b;
   ...
   if(IsInRect(p1->x,p1->y,r)) return 1;
   if(IsInRect(p2->x,p2->y,r)) return 1;
   m.w=0;
