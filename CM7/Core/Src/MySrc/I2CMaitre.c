...
{
	return HAL_I2C_IsDeviceReady(&hi2c1,ad<<1,2,2)==HAL_OK;
}

uint16_t I2CWriteByte(uint8_t ad, uint8_t b)
{
	return HAL_I2C_Master_Transmit(&hi2c1,ad<<1,&b,1,2);
}
...
{
	return HAL_I2C_Master_Transmit(&hi2c1,ad<<1,b,nb,2);
}
...
{
    adx.b.cmd=cmde;
    return HAL_I2C_Mem_Read(&hi2c1,ad<<1,adx.w,2,data,nb,5);
}
